...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.ch02.setTransform(1417.2,50.55,1,1,0,0,0,67.2,-1.4);
	...
	this.ch03.setTransform(1417.2,460,1,1,0,0,0,67.2,-1.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch03},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
