...
function init(){
	...
	//製造籃球柱
	cylinder1 =new TEACHER.ObjCylinder(4 , 30 , 0x0000ff)
	cylinder1.position.x = 0
	cylinder1.position.y = 15
	cylinder1.position.z = -46
	scene.add(cylinder1)

	cylinder2 =new TEACHER.ObjCylinder(3 , 20 , 0xffffff)
	cylinder2.position.x = 0
	cylinder2.position.y = 40
	cylinder2.position.z = -46
	scene.add(cylinder2)

	cylinder3 =new TEACHER.ObjCylinder(3 , 20 , 0xffffff , false , 'z')
	cylinder3.position.x = 0
	cylinder3.position.y = 45
	cylinder3.position.z = -35
	scene.add(cylinder3)

	//製造籃板
	board1 = new TEACHER.ObjBox(25 , 16 , 3 , 0xffffff , 0)
	board1.position.x = 0
	board1.position.y = 50
	board1.position.z = -25
	scene.add(board1)

	 //製造籃版框
	board2 = new TEACHER.ObjBox(30 , 2 , 3 , 0xff0000 , 0)
	board2.position.x = 0
	board2.position.y = 59
	board2.position.z = -25
	scene.add(board2)

	board3 = new TEACHER.ObjBox(30 , 2 , 3 , 0xff0000 , 0)
	board3.position.x = 0
	board3.position.y = 41
	board3.position.z = -25
	scene.add(board3)

	board4 = new TEACHER.ObjBox(3 , 20 , 3 , 0xff0000 , 0)
	board4.position.x = 14
	board4.position.y = 50
	board4.position.z = -25
	scene.add(board4)

	board5 = new TEACHER.ObjBox(3 , 20 , 3 , 0xff0000 , 0)
	board5.position.x = -14
	board5.position.y = 50
	board5.position.z = -25
	scene.add(board5)

	 //製造籃板內框
	board6 = new TEACHER.ObjBox(11 , 1 , 3 , 0xff0000 , 0)
	board6.position.x = 0
	board6.position.y = 46
	board6.position.z = -25
	scene.add(board6)

	board8 = new TEACHER.ObjBox(1 , 6 , 3 , 0xff0000 , 0)
	board8.position.x = 5
	board8.position.y = 43
	board8.position.z = -25
	scene.add(board8)

	board9 = new TEACHER.ObjBox(1 , 6 , 3 , 0xff0000 , 0)
	board9.position.x = -5
	board9.position.y = 43
	board9.position.z = -25
	scene.add(board9)

	//製造籃框
	net = new TEACHER.ObjCylinder(10 , 10 , 0xffffff , true , "y" , 2)
	net.position.x = 0
	net.position.y = 37
	net.position.z = -15
	scene.add(net)
	...
	//製造籃球
	ball = new TEACHER.ObjPicSphere(6 , pics.ball)
	ball.position.x = 0
	ball.position.y = 20
	ball.position.z = 20 
	scene.add(ball)
	...
	//我的名字
	aa = new TEACHER.ObjTextPlane(115 , 20 , '158103江倍伸' , 'z' , 0xff5500 , )	
	aa.position.z = -50	
	aa.position.y = 20		
	...
	//投籃
	world2D.btn01.setLabel('投籃')
	world2D.btn01.on('mousedown' , clickBtn)
	//重來
	world2D.btn02.setLabel('再來一球')
	world2D.btn02.on('mousedown' , clickBtn)

	world2D.sl01.setLabel('球y方向力道')
	world2D.sl01.minimum = 0
	world2D.sl01.maximum = 20
	world2D.sl01.value = 12

	world2D.sl02.setLabel('球z方向力道')
	world2D.sl02.minimum = 0
	world2D.sl02.maximum = 20
	world2D.sl02.value = 6

	world2D.sl03.setLabel('籃框移動倍速')
...
function tick(){
	...
	if(f){
		if(cylinder1.position.x > 46){
			v = -(world2D.sl03.value)/2
		}else if(cylinder1.position.x < -46){
			v = (world2D.sl03.value)/2
		}
		cylinder1.position.x += v
		cylinder2.position.x += v
		cylinder3.position.x += v
		board1.position.x += v
		board2.position.x += v
		board3.position.x += v
		board4.position.x += v
	...
	d3 = board1.position.x
	e3 = a3 - d3

	f2 = cylinder1.position.z
	g2 = a2 - f2

	f3 = cylinder1.position.x
	g3 = a3 - f3
...
function clickBtn(e){
	...
	if(str === 'btn01'){
		if(ball.vz === 0){
			ball.vz = -world2D.sl02.value
			ball.vy = world2D.sl01.value
			ball.ay = -2
			z = 1
		}
	}else if (str === 'btn02'){
