...
//B.定義init
function init(){
	a=new TEACHER.ObjPicSphere(r,pics.bowling,0)
	b=new TEACHER.ObjPicPlane(30,100,pics.road,"y",0)
	c=new TEACHER.ObjPicPlane(20,15,pics.bottle,"x",1)
	d=new TEACHER.ObjPicPlane(46,25,pics.strike,"z",2)
	e=new TEACHER.ObjPicPlane(48,27,pics.screen,"z")
	f=new TEACHER.ObjTextPlane(40,5,"1595班17號 吳宗餘","z",0xffffff)
