...
//B.定義init
function init(){
wheel2=wheel1=new TEACHER.ObjPicCylinder(5,25,pics.black,false,"z");
wheel1=new TEACHER.ObjPicCylinder(5,25,pics.black,false,"z");
kun=new TEACHER.ObjPicPlane(35,35,pics.kun,"y",2);
aa=new TEACHER.ObjPicPlane(100,50,pics.han,"z",0);
aaa=new TEACHER.ObjPicPlane(100,50,pics.chen,"x",0);
aaaa=new TEACHER.ObjPicPlane(100,50,pics.chen,"x",1);
hewa=new TEACHER.ObjPicCylinder(7.5,10,pics.hewa);
nname=new TEACHER.ObjPicPlane(100,30,pics.name,"z",2);
    scene.add(nname);
    scene.add(kun);
    scene.add(wheel2);
    scene.add(wheel1);
	...
	wheel1.position.y=5;
	wheel2.position.y=5;
	wheel2.position.x=7.5;
	wheel1.position.x=-7.5;
	hewa.position.y=15;
	aa.position.z=-45;
	aa.position.y=25;
	aaa.position.x=-50;
	...
	aaaa.position.x=50;
	aaaa.position.y=25;
world2D.btn01.setLabel('丟何威');
world2D.btn02.setLabel('阻尼震盪');
world2D.ch01.setLabel('牆');
world2D.ch02.setLabel('停止');
world2D.sl01.setLabel('b值');
world2D.sl02.setLabel('k值');
world2D.sl03.setLabel('何威初速');
...
world2D.btn01.on('click',clicka);
world2D.btn02.on('click',clicka);
...
aa.visible=aaa.visible=aaaa.visible=world2D.ch01.checked;
k=world2D.sl02.value;
b=world2D.sl01.value;
if(a===1){
dv+=(-k*kun.position.x-b*dv)*dt;
kun.position.x+=dv*dt;
wheel1.position.x+=dv*dt;
wheel2.position.x+=dv*dt;
hewa.position.x+=dv*dt;
wheel1.rotation.z-=dv*dt/5;
wheel2.rotation.z-=dv*dt/5;
}
if(bb===1){
	v+=-9.8*dt;
	hewa.position.y+=v;
	hewa.rotation.y+=0.1;
	if(hewa.position.y<15&& v<0){
		v=world2D.sl03.value;
	}
}
	//3D
	world3D.render();
...
kun.position.x=37.5;
hewa.position.x=37.5;
wheel2.position.x=45;
wheel1.position.x=30;
kun.position.z=0;
hewa.position.z=0;
wheel2.position.z=0;
wheel1.position.z=0;
