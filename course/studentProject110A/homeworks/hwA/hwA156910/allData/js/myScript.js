...
function init(){
	...
	ballw=new TEACHER.ObjSphere(5,0xffffff,2);
	ballr=new TEACHER.ObjCylinder(5,2,0xff0000,false,"z",2);
	ballr2=new TEACHER.ObjCylinder(2,9.8,0xff0000,false,"y",2);
    ball.add(ballw,ballr,ballr2);
	ball.position.y=5;
    
	//文字
	text=new TEACHER.ObjTextPlane(40,6,"156910胡晏慈","y",0xff0000);
	scene.add(text);
	text.position.x=0;
	text.position.y=15;
	text.position.z=-5;

	text2=new TEACHER.ObjTextPlane(40,6,"<起點","y",0xff0000);
	scene.add(text);
	text2.position.x=-35;
	text2.position.y=15;
	text2.position.z=-45;
	...
	text3=new TEACHER.ObjTextPlane(80,6,"遊戲目標：躲避障礙物到達終點!","y",0xff0000,0xffff00);
	scene.add(text);
	text3.position.x=0;
	text3.position.y=15;
	text3.position.z=5;
	...
	text4=new TEACHER.ObjTextPlane(10,20,"終","y",0xff0000,0xffffff);
	scene.add(text4);
	text4.position.x=-45;
	text4.position.y=0;
	text4.position.z=15;
	
    text5=new TEACHER.ObjTextPlane(10,20,"點","y",0xff0000,0xffffff);
	scene.add(text5);
	text5.position.x=-45;
	text5.position.y=0;
	text5.position.z=35;

	boxa=new TEACHER.ObjBox(10,15,20,0xffff00,2);
	scene.add(boxa);
	boxa.position.x=25;
	boxa.position.y=7.5;
	boxa.position.z=20;

	boxb=new TEACHER.ObjBox(10,15,20,0xffff00,2);
	scene.add(boxb);
	boxb.position.x=-5;
	boxb.position.y=7.5;
	boxb.position.z=20;

	boxc=new TEACHER.ObjBox(10,15,20,0xffff00,2);
	scene.add(boxc);
	boxc.position.x=-35;
	boxc.position.y=7.5;
	boxc.position.z=25;
	...
	box=new TEACHER.ObjBox(90,15,10,0xffff00,2);
    scene.add(box);
	box.position.x=-5;
	box.position.y=7.5;
	box.position.z=-5;
	box=new TEACHER.ObjBox(10,15,30,0xffff00,2);
    scene.add(box);
	box.position.x=-35;
	box.position.y=7.5;
	box.position.z=-35
	...
	world2D.ch02.setLabel('遊戲目標');
	world2D.btn01.setLabel("回到起點");
...
//C.定義tick                                                                                                                       
function tick(){
    if(boxa.position.z>40 && fx>0){
		fx=-0.3;
	}else if(boxa.position.z<5 && fx<0){
		fx=0.3;
	}boxa.position.z+=fx;
	...
	if(boxb.position.z>25 && fx<0){
		fx=0.3;
	}else if(boxb.position.z<0 && fx>0){
		fx=-0.3;
	}boxb.position.z-=fx;

	if(boxc.position.z>45 && fx>0){
		fx=-0.3;
	}else if(boxc.position.z<15 && fx<0){
		fx=0.3;
	}boxc.position.z+=fx;
	...
	//ball.position.x+=dx;
	if (gameMD===1){
		if(ball.position.z<-45 && dx>0){
			gameMD=0;
		}
		ball.position.z-=dx;
		ball.rotation.x-=dx/rr;
	}
	...
	if (gameMD===3){
		if(ball.position.x<-45 && dx>0){
			gameMD=0;
		}
		ball.position.x-=dx;
		ball.rotation.z+=dx/rr;
	}
	...
	text3.visible = world2D.ch02.checked;
