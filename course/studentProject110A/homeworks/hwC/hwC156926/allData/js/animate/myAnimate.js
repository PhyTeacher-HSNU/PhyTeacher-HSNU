...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btn01.setTransform(1200,550);

	this.btn03 = new lib.theButton();
	this.btn03.name = "btn01";
	this.btn03.parent = this;
	this.btn03.setTransform(1350,550);
	...
	this.ch03.setTransform(1417,296.25,1,1,0,0,0,67.2,-1.4);

	this.ch04 = new lib.theCheckbox();
	this.ch04.name = "ch04";
	this.ch04.parent = this;
	this.ch04.setTransform(1100,100,1,1,0,0,0,67.2,-1.4);

	this.ch05 = new lib.theCheckbox();
	this.ch05.name = "ch05";
	this.ch05.parent = this;
	this.ch05.setTransform(1200,200,1,1,0,0,0,67.2,-1.4);
	...
	this.sl01.setTransform(1350,30.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch03},{t:this.ch04},{t:this.ch05},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.btn03},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
