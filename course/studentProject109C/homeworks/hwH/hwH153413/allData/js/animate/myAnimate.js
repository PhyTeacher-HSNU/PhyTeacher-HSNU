...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btn03.setTransform(150,550);
	...
	this.btn04.setTransform(800,550);


	this.ch02 = new lib.theCheckbox();
	this.ch02.name = "ch02";
	this.ch02.parent = this;
	this.ch02.setTransform(1417.2,368.4,1,1,0,0,0,67.2,-1.4);
	...
	this.sl05.setTransform(150,122.45);

	this.sl04 = new lib.theSlider();
	this.sl04.name = "sl04";
	this.sl04.parent = this;
	this.sl04.setTransform(150,202.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl04},{t:this.sl05},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.btn03},{t:this.btn04},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
