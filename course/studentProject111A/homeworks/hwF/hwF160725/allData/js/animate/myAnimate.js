...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.slCameraRR.setTransform(1350,860);

	this.btn09 = new lib.theButton();
	this.btn09.name = "btn09";
	this.btn09.parent = this;
	this.btn09.setTransform(100,780);

	this.btn08 = new lib.theButton();
	this.btn08.name = "btn08";
	this.btn08.parent = this;
	this.btn08.setTransform(100,700);

	this.btn07 = new lib.theButton();
	this.btn07.name = "btn07";
	this.btn07.parent = this;
	this.btn07.setTransform(100,620);

	this.btn06 = new lib.theButton();
	this.btn06.name = "btn06";
	this.btn06.parent = this;
	this.btn06.setTransform(1500,780);

	this.btn05 = new lib.theButton();
	this.btn05.name = "btn05";
	this.btn05.parent = this;
	this.btn05.setTransform(1350,780);

	this.btn04 = new lib.theButton();
	this.btn04.name = "btn04";
	this.btn04.parent = this;
	this.btn04.setTransform(1500,700);

	this.btn03 = new lib.theButton();
	this.btn03.name = "btn03";
	this.btn03.parent = this;
	this.btn03.setTransform(1350,700);

	this.btn02 = new lib.theButton();
	this.btn02.name = "btn02";
	this.btn02.parent = this;
	this.btn02.setTransform(1500,620);

	this.btn01 = new lib.theButton();
	this.btn01.name = "btn01";
	this.btn01.parent = this;
	this.btn01.setTransform(1350,620);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1430,280,1,1,0,0,0,67.2,-1.4);

	this.sl02 = new lib.theSlider();
	this.sl02.name = "sl02";
	this.sl02.parent = this;
	this.sl02.setTransform(1350,200);

	this.sl01 = new lib.theSlider();
	this.sl01.name = "sl01";
	this.sl01.parent = this;
	this.sl01.setTransform(1350,120);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.ch01},{t:this.btn01},{t:this.btn02},{t:this.btn03},{t:this.btn04},{t:this.btn05},{t:this.btn06},{t:this.btn07},{t:this.btn08},{t:this.btn09},{t:this.slCameraRR}]}).wait(1));
