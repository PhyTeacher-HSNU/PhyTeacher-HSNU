...
function init(){
	...
	var text1=new TEACHER.ObjTextPlane(20,10,"橫波",'z',0x00ffff);
	var text2=new TEACHER.ObjTextPlane(20,10,"駐波",'z',0xffff00);
	var text3=new TEACHER.ObjTextPlane(20,10,"縱波",'z',0xff0000);
	var text4=new TEACHER.ObjTextPlane(20,10,"蛇擺",'z',0xffffff);
    ...
    world2D.btnUp.visible=world2D.btnDown.visible=world2D.btnRight.visible=world2D.btnLeft.visible=world2D.ch01.visible=world2D.ch02.visible=false;
	for(var i=0;i<nn;i++){
		var ball1=new TEACHER.ObjSphere(0.6,0x00ff00,2);
		ball1.position.x=-100+2*i;
		ball1.position.y=10;
		ball1.position.z=z1;
		scene.add(ball1);
		ballArray1.push(ball1);

		var ball2=new TEACHER.ObjSphere(0.6,0x00ffff,2);
		ball2.position.x=-100+2*i;
		ball2.position.y=10;
		ball2.position.z=z2;
		scene.add(ball2);
		ballArray2.push(ball2);

		var ball3=new TEACHER.ObjSphere(1,0xffff00,2);
		ball3.position.x=-100+2*i;
		ball3.position.y=10;
		ball3.position.z=z3;
		scene.add(ball3);
	...
	for(var i=0;i<20;i++){
	    ...
	    var ball4=new TEACHER.ObjSphere(2,0xffffff,2);
		ball4.position.x=-60+6*i;
		ball4.position.y=10;
		ball4.position.z=70;
		scene.add(ball4);
		ballArray4.push(ball4);
	}
	for(var i=0;i<30;i++){

	    var ball5=new TEACHER.ObjBox(1,5,5,0xff0000,2);
		ball5.position.x=-90+6*i;
		ball5.position.y=10;
		ball5.position.z=50;
		scene.add(ball5);
		ballArray5.push(ball5);
	}
...
function tick(){
    ...
    for(var i=0;i<30;i++){
		var b5=ballArray5[i];
		var xx5=AA/2*Math.sin( 2*Math.PI*b5.position.x/lambda - 2*Math.PI*t*2/period);
		b5.position.x=-90+6*i+xx5;
	}
	for(var i=0;i<20;i++){
		var b4=ballArray4[i];
		var zz4=5*Math.sin( 2*Math.PI*b4.position.x/lambda - 2*Math.PI*t*2/(period+i));
		b4.position.z=70+zz4;
	}
