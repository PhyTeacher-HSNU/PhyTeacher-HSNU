...
var pts;
 var N=100;
  ...
  function init(){ 
	...
	ground.visible=skyBox.visible=world2D.btn01.visible=world2D.btn02.visible=world2D.ch02.visible=world2D.btnUp.visible=world2D.btnDown.visible=world2D.btnLeft.visible=world2D.btnRight.visible=false; 
	world2D.sl01.setLabel("n1");
	world2D.sl02.setLabel("m1");
	world2D.sl03.setLabel("A1");
	world2D.sl04.setLabel("n2");
	world2D.sl05.setLabel("m2");
	world2D.sl06.setLabel("A2");
	world2D.sl03.digitN=world2D.sl06.digitN=1;
	world2D.sl03.minimum=world2D.sl06.minimum=0;
	world2D.sl03.maximum=world2D.sl06.maximum=10;
	world2D.ch01.setLabel("圓形");
	world2D.sl02.minimum=world2D.sl05.minimum=0;
	world2D.sl01.minimum=world2D.sl04.minimum=1;
	world2D.sl01.maximum=world2D.sl02.maximum=world2D.sl04.maximum=world2D.sl05.maximum=6; 
	world2D.sl01.value=world2D.sl02.value=world2D.sl04.value=world2D.sl05.value=1; 
...
//C.定義tick 
function tick(){ 
	A1=world2D.sl03.value;
	A2=world2D.sl06.value;
	n1=Math.floor(world2D.sl01.value); 
	m1=Math.floor(world2D.sl02.value); 
	n2=Math.floor(world2D.sl04.value); 
	m2=Math.floor(world2D.sl05.value); 
	world2D.sl01.value=Math.floor(world2D.sl01.value+0.5); 
	world2D.sl02.value=Math.floor(world2D.sl02.value+0.5); 
	world2D.sl04.value=Math.floor(world2D.sl04.value+0.5); 
	world2D.sl05.value=Math.floor(world2D.sl05.value+0.5); 
	tt+=dt; 
	for(var ix=0;ix<N;ix++){ 
		for(var iz=0;iz<N;iz++){ 
			if(world2D.ch01.checked){ 
				...
				jjmm1(afaArray[6*m1+n1-1]/(a/2)*iz*(a/2)/N); 
				jjmm2(afaArray[6*m2+n2-1]/(a/2)*iz*(a/2)/N); 
				var yy=A1*Math.cos(cc*afaArray[6*m1+n1-1]/(a/2)*tt)*Math.cos(m1*ix/N*2*Math.PI)*jmm1+A2*Math.cos(cc*afaArray[6*m2+n2-1]/(a/2)*tt)*Math.cos(m1*ix/N*2*Math.PI)*jmm2; 
				jmm1=0; 
				jmm2=0; 
			}else{ 
				dt=0.5;
				var xx=-50+100*ix/N; 
				var zz=-50+100*iz/N; 
				var yy=A1/2*Math.cos(Math.PI*cc*Math.sqrt(n1/a*n1/a+m1/b*m1/b)*tt)*Math.sin(n1*Math.PI/a*(xx+50))*Math.sin(m1*Math.PI/b*(zz+50))+A1/2*Math.cos(Math.PI*cc*Math.sqrt(m1/a*m1/a+n1/b*n1/b)*tt)*Math.sin(m1*Math.PI/a*(xx+50))*Math.sin(n1*Math.PI/b*(zz+50))+A2/2*Math.cos(Math.PI*cc*Math.sqrt(n2/a*n2/a+m2/b*m2/b)*tt)*Math.sin(n2*Math.PI/a*(xx+50))*Math.sin(m2*Math.PI/b*(zz+50))+A2/2*Math.cos(Math.PI*cc*Math.sqrt(m2/a*m2/a+n2/b*n2/b)*tt)*Math.sin(m2*Math.PI/a*(xx+50))*Math.sin(n2*Math.PI/b*(zz+50)); 
...
function jjmm1(x){ 
	for(var i=0 ;i <50 ;i++){ 
		...
		for(var ii=1; ii<i+m1+1 ;ii++){ 
			imj*=ii; 
		} 
		jmm1+=Math.pow(-1,i)*Math.pow(x/2,2*i+m1)/ij/imj; 
	} 
}
function jjmm2(x){ 
	for(var i=0 ;i <50 ;i++){ 
		...
		for(var ii=1; ii<i+m2+1 ;ii++){ 
			imj*=ii; 
		} 
		jmm2+=Math.pow(-1,i)*Math.pow(x/2,2*i+m2)/ij/imj; 
	} 
}
