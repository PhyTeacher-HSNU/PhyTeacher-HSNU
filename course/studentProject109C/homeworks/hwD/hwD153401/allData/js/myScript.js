...
function init(){
for(var i=0;i<nn;i++){
    bb=new TEACHER.ObjSphere(0.8,0xff9900)/*Plane(1,20,0x111111,"x",2)*/
    bb.position.y=0+i*2
    scene.add(bb)
    ballarray1.push(bb)
	}
...
scene.add(cc)
oo=new TEACHER.ObjPicSphere(10,pics.my,2)
cc.add(oo)
oo.position.x=30
oo.position.y=30
pp=new TEACHER.ObjPicSphere(10,pics.class,2)
cc.add(pp)
pp.position.x=-30
pp.position.y=30
...
function tick(){
	...
	pp.rotation.y-=0.5
    t+=dt
    dt=world2D.sl02.value
	A=world2D.sl01.value
	R=world2D.sl03.value
//for(var d=0;d<396;d+=36){
	for(var i=0;i<nn;i++){
		bb=ballarray1[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(0*2*Math.PI/180)
	//縱波
		//bb.position.y=-50+i*2+yy
	//橫波
	    bb.position.x=(yy+10)*Math.cos(0*2*Math.PI/180)
	ballarray1.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray2[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(18*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(18*2*Math.PI/180)
		ballarray2.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray3[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(36*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(36*2*Math.PI/180)
		ballarray3.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray4[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(54*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(54*2*Math.PI/180)
		ballarray4.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray5[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(72*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(72*2*Math.PI/180)
		ballarray5.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray6[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(90*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(90*2*Math.PI/180)
		ballarray6.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray7[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(108*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(108*2*Math.PI/180)
		ballarray7.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray8[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(126*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(126*2*Math.PI/180)
		ballarray8.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray9[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(144*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(144*2*Math.PI/180)
		ballarray9.push(bb)
	}
	for(var i=0;i<nn;i++){
		bb=ballarray10[i]
		yy= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
		zz= A *Math.sin( 2*Math.PI*(-50+i*2)/R - 2*Math.PI*t/T )
	    bb.position.z=(zz+10)*Math.sin(162*2*Math.PI/180)
		bb.position.x=(yy+10)*Math.cos(162*2*Math.PI/180)
		ballarray10.push(bb)
	}
			...
			}//else if(Gamemode===0){dt=world2D.sl02.value}
	//3D
	world3D.render();
	//2D
