...
var pp;
var bb;
var ball_1,ball_2,ball_3,bar1
var ball_4,ball_5,ball_6,bar2
var ball_7,ball_8,ball_9,bar3
...
//B.定義init
function init(){
	pp=new TEACHER.ObjTextPlane(80,10,"159011林宥錡",'z',0xffffff);
	scene.add(pp);
	pp.position.z=-50;
	pp.position.y=20;

    bb=new TEACHER.ObjBox(40,15,30,0x0f0f0f)
	scene.add(bb)
	bb.position.y=-2

	ground.visible=false;

	pts=new TEACHER.Points(0xffff00,2,10000);
	for(var i=0;i<nn*nn;i++){
		pts.addPoint(1.5*(i%nn-0.5*nn),0,1.2*(Math.floor(i/nn)-0.5*nn));
	}
	pts.position.y=6
	pts.update();
	scene.add(pts);
	...
	ball_1=new TEACHER.ObjSphere(2,0xff0000)
	ball_2=new TEACHER.ObjBox(4,4,4,0xff0000)
	ball_3=new TEACHER.ObjSphere(2,0xff0000)
    ball_1.position.z=-5
	ball_3.position.z=5
	ball_1.position.y=ball_2.position.y=ball_3.position.y=10
	scene.add(ball_1,ball_2,ball_3)

	bar1=new TEACHER.ObjCylinder(0.3,25,0x00ff00,false,'z');
	bar1.position.y=10
	bar1.position.z=5
	scene.add(bar1);

	ball_4=new TEACHER.ObjBox(4,4,4,0xff0000)
	ball_5=new TEACHER.ObjSphere(2,0xff0000)
	ball_6=new TEACHER.ObjBox(4,4,4,0xff0000)
    ball_4.position.z=-5
	ball_6.position.z=5
	ball_4.position.y=ball_5.position.y=ball_6.position.y=10
	ball_4.position.x=ball_5.position.x=ball_6.position.x=-10
	scene.add(ball_4,ball_5,ball_6)

	bar2=new TEACHER.ObjCylinder(0.3,25,0x00ff00,false,'z');
	bar2.position.y=10
	bar2.position.z=5
	bar2.position.x=-10
	scene.add(bar2);

	ball_7=new TEACHER.ObjBox(4,4,4,0xff0000)
	ball_8=new TEACHER.ObjSphere(2,0xff0000)
	ball_9=new TEACHER.ObjBox(4,4,4,0xff0000)
    ball_7.position.z=-5
	ball_9.position.z=5
	ball_7.position.y=ball_8.position.y=ball_9.position.y=10
	ball_7.position.x=ball_8.position.x=ball_9.position.x=10
	scene.add(ball_7,ball_8,ball_9)

	bar3=new TEACHER.ObjCylinder(0.3,25,0x00ff00,false,'z');
	bar3.position.y=10
	bar3.position.z=5
	bar3.position.x=10
	scene.add(bar3);

	a1=new TEACHER.ObjBox(40,0.5,0.5,"#c0c0c0")
	a1.position.y=7.5
	a1.position.z=-15
	scene.add(a1)
	a2=new TEACHER.ObjBox(40,0.5,0.5,"#c0c0c0")
	a2.position.y=7.5
	a2.position.z=-7.5
	scene.add(a2)
	a3=new TEACHER.ObjBox(40,0.5,0.5,"#c0c0c0")
	a3.position.y=7.5
	a3.position.z=0
	scene.add(a3)
	a4=new TEACHER.ObjBox(40,0.5,0.5,"#c0c0c0")
	a4.position.y=7.5
	a4.position.z=7.5
	scene.add(a4)
	a10=new TEACHER.ObjBox(40,0.5,0.5,"#c0c0c0")
	a10.position.y=7.5
	a10.position.z=15
	scene.add(a10)
	a5=new TEACHER.ObjBox(0.5,0.5,30,"#c0c0c0")
	a5.position.y=7.5
	a5.position.x=-20
	scene.add(a5)
	a6=new TEACHER.ObjBox(0.5,0.5,30,"#c0c0c0")
	a6.position.y=7.5
	a6.position.x=-12
	scene.add(a6)
	a7=new TEACHER.ObjBox(0.5,0.5,30,"#c0c0c0")
	a7.position.y=7.5
	a7.position.x=-4
	scene.add(a7)
	a8=new TEACHER.ObjBox(0.5,0.5,30,"#c0c0c0")
	a8.position.y=7.5
	a8.position.x=4
	scene.add(a8)
	a9=new TEACHER.ObjBox(0.5,0.5,30,"#c0c0c0")
	a9.position.y=7.5
	a9.position.x=12
	scene.add(a9)
	a11=new TEACHER.ObjBox(0.5,0.5,30,"#c0c0c0")
	a11.position.y=7.5
	a11.position.x=20
	scene.add(a11)

	world2D.slCameraRR.value=90;
	world3D.cameraTheta=45;
	pts.visible=false;
...
function tick(){
	...
	for(var i=0;i<nn*nn;i++){
		...
		var yy=2*Math.sin(2*Math.PI*rr/5-2*Math.PI*tt/5)

		pts.setPoint(i,xx,yy,zz);
	}
	pts.update();

	ball_1.rotation.z-=world2D.sl01.value;
	ball_2.rotation.z-=world2D.sl01.value;
	ball_3.rotation.z-=world2D.sl01.value;
	ball_4.rotation.z-=world2D.sl01.value;
	ball_5.rotation.z-=world2D.sl01.value;
	ball_6.rotation.z-=world2D.sl01.value;
	ball_7.rotation.z-=world2D.sl01.value;
	ball_8.rotation.z-=world2D.sl01.value;
	ball_9.rotation.z-=world2D.sl01.value;
