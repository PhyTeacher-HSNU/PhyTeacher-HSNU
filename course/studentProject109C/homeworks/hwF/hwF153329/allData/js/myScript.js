...
function init(){
	...
	spring=new TEACHER.ObjSpring(10,1,0.2,5,0xffff00);
	scene.add(spring);
	spring.position.y=15;
	objarr.push(spring);

	obj1=new TEACHER.ObjCylinder(1,15,0xff0000,false,"y");
	scene.add(obj1);
	obj1.position.y=12.5;
	objarr.push(obj1);

	obj2=new TEACHER.ObjCylinder(1,8,0xff0000,false,"x");
	scene.add(obj2);
	obj2.position.y=5;
	objarr.push(obj2);

	obj3=new TEACHER.ObjCylinder(1,8,0xff0000,false,"x");
	scene.add(obj3);
	obj3.position.y=20;
	objarr.push(obj3);;

	obj4=new TEACHER.ObjCylinder(1,10,0x00ffff,false,"z");
	scene.add(obj4);
	obj4.position.y=20;
	obj4.position.x=4;
	obj4.position.z=-4;
	...
	obj5=new TEACHER.ObjCylinder(1,10,0x00ffff,false,"z");
	scene.add(obj5);
	obj5.position.y=20;
	obj5.position.x=-4;
	obj5.position.z=-4;
	...
	obj6=new TEACHER.ObjBox(8,10,5,0x00ffff);
	scene.add(obj6);
	obj6.position.y=15;
	obj6.position.z=-7.5;
	objarr.push(obj6);

	obj7=new TEACHER.ObjCylinder(1.5,4,0x00ffff,false,"y");
	scene.add(obj7);
	obj7.position.y=22;
	obj7.position.z=-7.5;
	objarr.push(obj7);

	obj8=new TEACHER.ObjSphere(3,0x00ffff);
	scene.add(obj8);
	obj8.position.y=23.5;
	obj8.position.z=-7.5;
	objarr.push(obj8);

	obj9=new TEACHER.ObjCylinder(1.5,10,0x00ffff);
	scene.add(obj9);
	obj9.position.y=9;
	obj9.position.z=-4.5;
	obj9.position.x=3;
	objarr.push(obj9);
	obj9.rotation.x=-Math.PI/4;

	obj10=new TEACHER.ObjCylinder(1.5,10,0x00ffff);
	scene.add(obj10);
	obj10.position.y=9;
	obj10.position.z=-4.5;
	obj10.position.x=-3;
	objarr.push(obj10);
	obj10.rotation.x=-Math.PI/4;
...
function tick(){
	...
	if(y>0){
		spring.position.y=obj1.position.y-10-7.5;
	}
	if(y<0){
		spring.position.y=0;
		spring.scale.y=(obj1.position.y-7.5)/10;
	}
	log(y);
