...
function init(){
	...
	for(var i = 0 ; i < nn ; i ++){
		ball = new TEACHER.ObjPicSphere(rr, pics.ball, 0);
		scene.add(ball);
		ball.position.y = rr;
		ball.position.x = -25 + (i % 10) * 5;
		ball.position.z = -25 + Math.floor(i / 10) * 5;
