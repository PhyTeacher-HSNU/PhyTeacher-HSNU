...
//B.定義init
function init(){
	QAQ=new TEACHER.ObjTextPlane(20,10,'時間:','z',0x000000)
	QAQ.position.z=-30
	QAQ.position.x=35
	QAQ.position.y=40
	scene.add(QAQ)
	time=new TEACHER.ObjTextPlane(20,10,'時間','z',0x000000)
	time.position.z=-30
	time.position.x=50
	time.position.y=40
	scene.add(time)
	gameover=new TEACHER.ObjTextPlane(160,20,'   ','z',0x000001)
gameover.position.y=30
scene.add(gameover)
world2D.slCameraRR.value=130;
var river=new TEACHER.ObjPlane(110,10000,0x00ffff,'y',2)
river.position.y=2.5
scene.add(river);
var ground=new TEACHER.ObjPlane(110,10000,0x708090,'y',2)
ground.position.y=-5
scene.add(ground);

rock1=new TEACHER.ObjBox(10,30,10,0x696969,2)
rock1.position.x=(Math.random()*100)-50
rock1.position.z=-100
rock1.visible=false

rock2=new TEACHER.ObjBox(10,30,10,0x696969,2)
rock2.position.x=(Math.random()*100)-50
rock2.position.z=-100
rock2.visible=false

rock3=new TEACHER.ObjBox(10,30,10,0x808080,2)
rock3.position.x=(Math.random()*100)-50
rock3.position.z=-100
rock3.visible=false

rock4=new TEACHER.ObjBox(10,30,10,0x808080,2)
rock4.position.x=(Math.random()*100)-50
rock4.position.z=-100
rock4.visible=false

scene.add(rock1).add(rock2).add(rock3).add(rock4);



for(var i=0 ;i<nn;i++){
    var ball=new TEACHER.ObjSphere(rr,0x0000ff,2)
    ball.position.z=i*2+40
	ball.position.y=10
	ball.scale.x=ball.scale.y=ball.scale.z=1/i+0.5
    scene.add(ball);
	ballArray.push(ball);
...
world2D.ch01.setLabel('1547 29');
world2D.ch02.setLabel('黃明遠');
...
var y = AA*Math.sin( 2*Math.PI*ball.position.z/lambda - 2*Math.PI*tt/period )+5.5
ball.position.y=y
rockSpeed=world2D.sl02.value
//1
if(rock1.visible=true&&rock1.position.z<100){      
	rock1.position.z+=rockSpeed
}else if(rock1.position.z>=100){
	rock1.position.z=-100
	rock1.position.x=(Math.random()*100)-50
}
if(Math.abs((ball.position.z)-(rock1.position.z+5)<rr) && (ball.position.x<=(rock1.position.x+5) && ball.position.x>=(rock1.position.x-5))){
ball.visible=false
ball.position.z=200
...
//2
if(rock2.visible=true&&rock2.position.z<100){      
	rock2.position.z+=rockSpeed
}else if(rock2.position.z>=100){
	rock2.position.z=-100
	rock2.position.x=(Math.random()*100)-50
}
if(Math.abs((ball.position.z)-(rock2.position.z+5)<rr) && (ball.position.x<=(rock2.position.x+5) && ball.position.x>=(rock2.position.x-5))){
	/*rock2.position.z=-100
	rock2.position.x=(Math.random()*100)-50*/
	ball.visible=false
ball.position.z=200
...
//3
if(rock3.visible=true&&rock3.position.z<100){      
	rock3.position.z+=rockSpeed
}else if(rock3.position.z>=100){
	rock3.position.z=-100
	rock3.position.x=(Math.random()*100)-50
}
if(Math.abs((ball.position.z)-(rock3.position.z+5)<rr) && (ball.position.x<=(rock3.position.x+5) && ball.position.x>=(rock3.position.x-5))){
	/*rock3.position.z=-100
	rock3.position.x=(Math.random()*100)-50*/
	ball.visible=false
ball.position.z=200
...
//4
if(rock4.visible=true&&rock4.position.z<100){      
	rock4.position.z+=rockSpeed
}else if(rock4.position.z>=100){
	rock4.position.z=-100
	rock4.position.x=(Math.random()*100)-50
}
if(Math.abs((ball.position.z)-(rock4.position.z+5)<rr) && (ball.position.x<=(rock4.position.x+5) && ball.position.x>=(rock4.position.x-5))){
	/*rock4.position.z=-100
	rock4.position.x=(Math.random()*100)-50*/
	ball.visible=false
ball.position.z=200
...
if(ball.position.x<-50){
	...
	if(str==="btn01"){
		...
		ball.position.z=i*2+40
        ball.visible=true
		rock1.visible=rock2.visible=rock3.visible=
		rock4.visible=true
		rock1.position.z=rock2.position.z=rock3.position.z=rock4.position.z=-100
		rockSpeed=world2D.sl02.value
		dt=0.1
		}
	}
