...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btn06.setTransform(1500,600);
	...
	this.btn04.setTransform(1500,520);
	...
	this.btn02.setTransform(1500,440);

	this.btn01 = new lib.theButton();
	this.btn01.name = "btn01";
	this.btn01.parent = this;
	this.btn01.setTransform(1350,440);

	this.ch02 = new lib.theCheckbox();
	this.ch02.name = "ch02";
	this.ch02.parent = this;
	this.ch02.setTransform(1417.2,360,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1417.2,280,1,1,0,0,0,67.2,-1.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.btn03},{t:this.btn04},{t:this.btn05},{t:this.btn06},{t:this.slCameraRR}]}).wait(1));
