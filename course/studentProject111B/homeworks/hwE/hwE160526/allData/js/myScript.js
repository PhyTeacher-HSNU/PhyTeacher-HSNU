...
function init(){
	...
	text=new TEACHER.ObjTextPlane(20,10," 彩帶人 ")
	scene.add(text)
	text.position.z=30
	text.position.x=30
	text.position.y=5
	...
	for(var i=0; i<nn;i++){
		var bb1 = new TEACHER.ObjSphere(0.5,0x00FFFF)
		bb1.position.x=-30+i/4
		bb1.position.y=40
		bb1.position.z=-10
		scene.add(bb1)
		ballArray1.push(bb1)

		var bb2 = new TEACHER.ObjSphere(0.5,0x00FF00)
		bb2.position.x=-30+i/4
		bb2.position.y=40
		bb2.position.z=10
		scene.add(bb2)
		ballArray2.push(bb2)

		/*var bb3 = new TEACHER.ObjSphere(0.9,0xFFFF00)
	...
	hand1 = new TEACHER.ObjBox(20,5,5)
	hand1.position.x=-40
	hand1.position.y=40
	hand1.position.z=-10
	scene.add(hand1)

	hand2 = new TEACHER.ObjBox(20,5,5)
	hand2.position.x=-40
	hand2.position.y=20
	hand2.position.z=10
	scene.add(hand2)

	body = new TEACHER.ObjBox(10,40,20,0xFFFF00)
	body.position.y=40
	body.position.x=-45
	scene.add(body)

	leg1 = new TEACHER.ObjBox(5,20,8)
	leg1.position.x=-40
	leg1.position.y=20
	leg1.position.z=6
	leg1.rotation.z=45*Math.PI/180
	scene.add(leg1)

	leg2 = new TEACHER.ObjBox(5,20,8)
	leg2.position.x=-40
	leg2.position.y=20
	leg2.position.z=-6
	leg2.rotation.z=45*Math.PI/180
	scene.add(leg2)

	leg3 = new TEACHER.ObjBox(5,20,8)
	leg3.position.x=-40
	leg3.position.y=9
	leg3.position.z=6
	leg3.rotation.z=-45*Math.PI/180
	scene.add(leg3)

	leg4 = new TEACHER.ObjBox(5,20,8)
	leg4.position.x=-40
	leg4.position.y=9
	leg4.position.z=-6
	leg4.rotation.z=-45*Math.PI/180
	scene.add(leg4)

	eyeR = new TEACHER.ObjBox(2.5,5,2.5,0xFF0000)
	scene.add(eyeR)
	eyeR.position.y=50
	eyeR.position.z=5
	eyeR.position.x=-40

	eyeL = new TEACHER.ObjBox(2.5,5,2.5,0xFF0000)
	scene.add(eyeL)
	eyeL.position.y=50
	eyeL.position.z=-5
	eyeL.position.x=-40
...
function tick(){
		...
		dt=0.1
		tt=tt+world2D.sl03.value*dt
		for (var i=0;i<nn;i++){
			var bb1 = ballArray1[i]
			var bb2 = ballArray2[i]
			//var bb3 = ballArray3[i]	
		
			var y1 = world2D.sl02.value*Math.sin( 2*Math.PI*bb1.position.x/world2D.sl01.value - 2*Math.PI*tt/period )
			var y2 = -world2D.sl02.value*Math.sin( 2*Math.PI*bb2.position.x/world2D.sl01.value - 2*Math.PI*tt/period )
	
			//var y3 = y1+y2
			
		bb1.position.y=40+y1
		bb2.position.y=40+y2
	
		//bb3.position.y=20+y3


		//bb3.position.z=z3
		var h1 = world2D.sl02.value*Math.sin( 2*Math.PI*(hand1.position.x+10)/world2D.sl01.value - 2*Math.PI*tt/period )
		hand1.position.y=40+h1

		var h2 = -world2D.sl02.value*Math.sin( 2*Math.PI*(hand2.position.x+10)/world2D.sl01.value - 2*Math.PI*tt/period )
		hand2.position.y=40+h2		
		}	
