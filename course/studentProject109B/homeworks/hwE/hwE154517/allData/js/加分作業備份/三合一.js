...
function init(){
	...
	for(var i=0 ; i<nn ; i++){
		//1
		var b = new TEACHER.ObjSphere(0.6,0x00ffff);
		b.position.x = -50+i*2;
		b.position.y = 10;
		b.position.z = z1;
		scene.add(b);
		ballArray1.push(b);
		//2
		var b = new TEACHER.ObjSphere(0.6,0x00ff00);
		b.position.x = -50+i*2;
		b.position.y =10;
		b.position.z = z2;
		scene.add(b);
		ballArray2.push(b);
		//3
		var b = new TEACHER.ObjSphere(0.9,0xffff00);
		b.position.x = -50+i*2;
		b.position.y =10;
		b.position.z = z3;
		scene.add(b);
...
function tick(){
	...
	for(var i=0 ; i<nn ; i++){
		...
		b1.visible = b2.visible = is12;
		
		ballArray1[i].mat.color.setHSL(0.3*(i+1)*Math.sin(0.01*tt),1,0.5);
		ballArray2[i].mat.color.setHSL(0.3*(i+1)*Math.sin(0.01*tt),1,0.5);
		ballArray3[i].mat.color.setHSL((i+1)*Math.sin(0.001*tt),1,0.5);
