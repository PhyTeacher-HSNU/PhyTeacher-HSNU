...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.ch01.setTransform(1417.2,480.4,1,1,0,0,0,67.2,-1.4);

	this.sl06 = new lib.theSlider();
	this.sl06.name = "sl06";
	this.sl06.parent = this;
	this.sl06.setTransform(1350,420);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.sl04},{t:this.sl05},{t:this.sl06},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
