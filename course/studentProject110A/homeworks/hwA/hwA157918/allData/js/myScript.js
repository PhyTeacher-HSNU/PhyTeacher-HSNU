...
//B.定義init
function init(){
	text=new TEACHER.ObjTextPlane(300,20,"1579班18號",0xf000000)
	text.position.z=-100
	text.position.x=0
	text.position.y=50
	scene.add(text)
	text2=new TEACHER.ObjTextPlane(300,20,"洪翊哲",0xf000000)
	text2.position.z=-100
	text2.position.x=0
	text2.position.y=30
	scene.add(text2)
	bar= new TEACHER.ObjCylinder(1.2,70,0xffffff,false,"y",2)
	bar.position.y=35
	scene.add(bar)
	circle= new TEACHER.ObjSphere(2,0xffff0f,2)
	circle.position.y=70
	scene.add(circle)
	block= new TEACHER.ObjBox(20,30,20,0x00000f,2)
	block.position.z=-40
	block.position.x=-40
	block.position.y=15
	scene.add(block)
	block2= new TEACHER.ObjBox(20,30,20,0x00000f,2)
	block2.position.z=-40
	block2.position.x=40
	block2.position.y=15
	scene.add(block2)
	block3= new TEACHER.ObjBox(20,30,20,0x00000f,2)
	block3.position.z=40
	block3.position.x=40
	block3.position.y=15
	scene.add(block3)
	block4= new TEACHER.ObjBox(20,30,20,0x00000f,2)
	block4.position.z=40
	block4.position.x=-40
	block4.position.y=15
	scene.add(block4)
	bridge= new TEACHER.ObjBox(60,5,10,0xffffff,2)
	bridge.position.z=40
	bridge.position.y=27.5
	scene.add(bridge)
	bridge2= new TEACHER.ObjBox(60,5,10,0xffffff,2)
	bridge2.position.z=-40
	bridge2.position.y=27.5
	scene.add(bridge2)
	bridge3= new TEACHER.ObjBox(10,5,60,0xffffff,2)
	bridge3.position.x=40
	bridge3.position.y=27.5
	scene.add(bridge3)
	bridge4= new TEACHER.ObjBox(10,5,60,0xffffff,2)
	bridge4.position.x=-40
	bridge4.position.y=27.5
	scene.add(bridge4)

	ball= new TEACHER.ObjPicSphere(10,pics.ball,2);
	scene.add(ball);
	...
	world2D.btn01.setLabel("開始轉動");
	world2D.btn02.setLabel("停止轉動");
...
function tick(){
	if(world2D.ch02.checked){
		...
		{	
			ball.position.x+=dx;
			ball.position.z+=dz;
			ball.rotation.x-=(dx2/rr);
			ball.rotation.z-=(dz2/rr);

			if(ball.position.x>40 && dx>0 )
			{
				dx=0
				dz=world2D.sl02.value
				dx2=-dz
				dz2=0
			}
			else if(ball.position.z>40 && dz>0 )
			{
				dz=0
				dx=-(world2D.sl02.value)
				dz2=-dx
				dx2=0
			}
			else if(ball.position.x<-40 && dx<0 )
			{
				dx=0
				dz=-(world2D.sl02.value)
				dx2=-dz
...
ball.rotation.y=world2D.sl02.value*Math.PI/180;
