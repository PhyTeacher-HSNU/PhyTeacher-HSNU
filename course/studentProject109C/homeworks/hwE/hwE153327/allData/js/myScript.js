...
function init(){
	...
	ball=new TEACHER.ObjSphere(2,0x00ff00);
	stars=new TEACHER.Points(0x000000,2);
	disc=new TEACHER.ObjCylinder(5,0.5,0X0000ff);
	desert1=new TEACHER.ObjPicPlane(600,600,pics.desert,x);
	desert1.rotation.x=-3.14/2;
	scene.add(desert1);
	ball.position.y=disc.position.y=20;
	scene.add(ball);
	scene.add(disc);
	pyr1=new TEACHER.ObjBox(10,2,10,0XFFFF00);
	pyr2=new TEACHER.ObjBox(6,2,6,0XFFFF00);
	pyr3=new TEACHER.ObjBox(2,2,2,0XFFFF00);
	pyr1.position.y=2;
	pyr2.position.y=4;
	pyr3.position.y=6;
	scene.add(pyr1);
	scene.add(pyr2);
	scene.add(pyr3);
	pyr1.visible=pyr2.visible=pyr3.visible=false;
	//scene.add(stars);
	//for(var i=0;i<100;i++){		
	//	var x=100*(Math.random()-0.5);
	//	var z=100*(Math.random()-0.5);
	//	for(var j=-1;j<2;j++){
	//		for(var l=-1;l<2;l++){
	//			stars.addPoint(x+100*j,5,z+100*l);
	//			}
	//		}
		
 	//}
	world2D.btn01.setLabel("金字塔");
...
function tick(){
	...
	x+=vx*dt;
	z+=vz*dt;
	desert1.position.x=-x;
	desert1.position.z=-z;	
	stars.position.x=-x;
	stars.position.y=-y;
	stars.position.z=-z;
	if(x>50){
...
function clickBtn(e){
	...
	if(str=="btnRight"){
		...
		pyr1.visible=pyr2.visible=pyr3.visible=true;
		pyr1.position.x=pyr2.position.x=pyr3.position.x=ball.position.x;
		pyr1.position.z=pyr2.position.z=pyr3.position.z=ball.position.z;
