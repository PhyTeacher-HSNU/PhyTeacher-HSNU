...
//B.定義init
function init(){
	ball=new TEACHER.ObjPicSphere(2,pics.chbal);
	scene.add(ball)
	world2D.sl01.setLabel('初轉速')
	world2D.sl01.minimum=-200
	world2D.sl01.maximum=200
	world2D.sl01.value=75
	world2D.sl02.setLabel('x')
	world2D.sl02.minimum=-40
	world2D.sl02.maximum=40
	world2D.sl02.value=0
	world2D.sl03.setLabel('hight')
	world2D.sl03.value=60
	world2D.sl03.minimum=4
	world2D.sl03.maximum=120
	ball.position.y=60
	world2D.ch01.setLabel('實心')
	world2D.ch01.checked=false;
	world2D.btn02.visible=false;
	world2D.ch02.visible=false;
	world2D.btn01.setLabel('restart')
	world2D.btn01.on('click',btn01cl)
	wz=world2D.sl01.value;
...
function tick(){
	...
	ball.rotation.z=ball.rotation.z+wz*dt/2
...
function btn01cl(){
	ball.position.y=world2D.sl03.value;
	ball.position.x=world2D.sl02.value;
	vx=vy=wz=0;
	wz=world2D.sl01.value;
}
