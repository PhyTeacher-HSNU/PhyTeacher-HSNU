...
//B.定義init
function init(){
	ncircle1=new TEACHER.ObjPicCylinder(4,0.01,pics.circle1,false,"z")
	ncircle2=new TEACHER.ObjPicCylinder(4,0.01,pics.circle1,false,"z")
	ncircle3=new TEACHER.ObjPicCylinder(4,0.01,pics.circle1,false,"z")
	ncircle4=new TEACHER.ObjPicCylinder(4,0.01,pics.circle1,false,"z")
	carbox=new TEACHER.ObjBox(18,6,8,0x000000)
	nstuname=new TEACHER.ObjPicPlane(100,25,pics.stuname,"z")
	...
	ncircle1.position.x=5
	ncircle2.position.x=5
	ncircle3.position.x=-5
	ncircle4.position.x=-5
	ncircle1.position.y=4
	ncircle2.position.y=4
	ncircle3.position.y=4
	ncircle4.position.y=4
	ncircle1.position.z=4.1
	ncircle2.position.z=-4.1
	ncircle3.position.z=4.1
	ncircle4.position.z=-4.1
	carbox.position.x=0
	carbox.position.z=0
	carbox.position.y=7
	nstuname.position.x=0
	nstuname.position.y=25
	nstuname.position.z=-50


	world2D.btn01.setLabel('簡諧運動')
	world2D.btn02.setLabel("牛頓第二定律")
	world2D.sl01.setLabel("阻尼或質量")
	world2D.sl02.setLabel("k或f")
	world2D.sl03.setLabel("初速")
	world2D.ch01.setLabel("播放")
	world2D.ch02.setLabel('LOGO')
	...
	world2D.sl02.minimum=-300
	world2D.sl02.maximum=300
	world2D.sl02.value=0
	world2D.sl01.minimum=1
	world2D.sl01.maximum=2000
	...
	world2D.btn01.on('click',funbtnclick01)
	world2D.btn02.on('click',funbtnclick02)
	world2D.btnLeft.on('click',funbtnclick03)
	world2D.btnRight.on('click',funbtnclick04)
...
function tick(){
	...
	if(world2D.ch01.checked===true){
		...
		vy+=ay*dt
		vz+=az*dt
		ncircle1.position.x+=vx*dt
		ncircle2.position.x+=vx*dt
		ncircle3.position.x+=vx*dt
		ncircle4.position.x+=vx*dt
		carbox.position.x+=vx*dt
		ncircle1.rotation.z-=vx*dt*1/4
		ncircle2.rotation.z-=vx*dt*1/4
		ncircle3.rotation.z-=vx*dt*1/4
		ncircle4.rotation.z-=vx*dt*1/4
		if(ngm===2){
			ax=world2D.sl02.value/world2D.sl01.value
		}else if(ngm===1){
			ax=-1*world2D.sl02.value*carbox.position.x-0.005*vx*world2D.sl01.value
		}
	}else{
		vx=world2D.sl03.value
	}
	nstuname.visible=world2D.ch02.checked
...
function funbtnclick01(t){
	ngm=1
	world2D.sl02.value=1
	world2D.sl02.minimum=0.1
	world2D.sl02.maximum=30
}
function funbtnclick02(t){
	ngm=2
	world2D.sl02.minimum=-300
	world2D.sl02.maximum=300
	world2D.sl02.value=0
}
function funbtnclick03(t){
	ncircle1.position.x-=3
	ncircle2.position.x-=3
	ncircle3.position.x-=3
	ncircle4.position.x-=3
	carbox.position.x-=3
}
function funbtnclick04(t){
	ncircle1.position.x+=3
	ncircle2.position.x+=3
	ncircle3.position.x+=3
	ncircle4.position.x+=3
