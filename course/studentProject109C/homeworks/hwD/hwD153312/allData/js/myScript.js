...
function init(){
	for (var i = 0 ; i < nn ; i ++){
		var a = new TEACHER.ObjPicSphere(1, pics.ballg, 0);
		a.position.x = -50 + i * 2;
		a.position.y = 10;
		a.position.z = z1;
		scene.add(a);
		...
		var b = new TEACHER.ObjPicSphere(1, pics.ballg, 0);
		b.position.x = -50 + i * 2;
		b.position.y = 10;
		b.position.z = z2;
		scene.add(b);
		...
		var c = new TEACHER.ObjPicSphere(1, pics.ballg, 0);
		c.position.x = -50 + i * 2;
		c.position.y = 10;
		c.position.z = z3;
		scene.add(c);
	...
	var bomb = new TEACHER.ObjPicCylinder(10, 30, pics.ballg, false, "x", 0);
	bomb.position.x = -65;
	bomb.position.y = 25;
	scene.add(bomb);
	var t1 = new TEACHER.ObjSphere(10, 0xff00ff, 0 );
	t1.position.x = -70;
	t1.position.y = 10;
	t1.position.z = 10;
	scene.add(t1);
	var t2 = new TEACHER.ObjSphere(10, 0xff00ff, 0 );
	t2.position.x = -70;
	t2.position.y = 10;
	t2.position.z = -10;
	scene.add(t2);
...
function tick(){
	...
	for(var i = 0 ; i < nn ; i ++){
		...
		b1.position.y = 25 + yy1;
		b2.position.y = 25 + yy2;
		b3.position.y = 25 + yy3;
