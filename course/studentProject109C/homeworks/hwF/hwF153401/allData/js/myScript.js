...
var L0=20
var spr1,spr2,spr3,sp4,sp5,sp6,sp7
var graph
var k1=5
var k2=0.3
var k3=4
...
//圖
graph=new TEACHER.ObjGraph(-40,10,20,-20,0xaa2288,0xffffff,10000)
graph.position.z=-50
scene.add(graph)
graph.labelTitle.setText(" 1534王誼章 ")
graph.labelX.setText("x")
graph.labelY.setText("z")



w1=new TEACHER.ObjBox(2,2*bR,2*bR,0x660000)
w2=new TEACHER.ObjBox(2,2*bR,2*bR,0x660000)
w1.position.x=-40-1
w2.position.x=40+1
w1.position.y=w2.position.y=bR
scene.add(w1)
scene.add(w2)
b1=new TEACHER.ObjSphere(bR,0xff0000)
b2=new TEACHER.ObjSphere(bR,0xff0000)
b1.position.x=-15
b2.position.x=15
b2.position.z=0
b1.position.z=0
b1.position.y=b2.position.y=bR
scene.add(b1)
scene.add(b2)
spr1=new TEACHER.ObjSpring(L0,0.8*bR,0.3,8,0x880000)
spr2=new TEACHER.ObjSpring(L0,0.8*bR,0.3,8,0x880000)
spr3=new TEACHER.ObjSpring(L0,0.8*bR,0.3,8,0x880000)
scene.add(spr1)
scene.add(spr2)
scene.add(spr3)
spr1.position.y=bR
spr2.position.y=bR
spr3.position.y=bR
sp4=new TEACHER.ObjSpring(30-bR,0.8*bR,0.3,8,0x880000)
scene.add(sp4)
sp4.position.y=bR
sp5=new TEACHER.ObjSpring(30-bR,0.8*bR,0.3,8,0x880000)
scene.add(sp5)
sp5.position.y=bR
sp6=new TEACHER.ObjSpring(30-bR,0.8*bR,0.3,8,0x880000)
scene.add(sp6)
sp6.position.y=bR
sp7=new TEACHER.ObjSpring(30-bR,0.8*bR,0.3,8,0x880000)
scene.add(sp7)
sp7.position.y=bR
...
b1.position.z+=za
b2.position.z+=zb
w3=new TEACHER.ObjBox(2*bR,2*bR,5,0xbb0000,2,2)
w3.position.x=b1.position.x-xa
w3.position.z=30+2.5
scene.add(w3)
w4=new TEACHER.ObjBox(2*bR,2*bR,5,0xbb0000,2,2)
w4.position.x=b1.position.x-xa
w4.position.z=-30-2.5
scene.add(w4)
w5=new TEACHER.ObjBox(2*bR,2*bR,5,0xbb0000,2,2)
w5.position.x=b2.position.x-xb
w5.position.z=30+2.5
scene.add(w5)
w6=new TEACHER.ObjBox(2*bR,2*bR,5,0xbb0000,2,2)
w6.position.x=b2.position.x-xb
w6.position.z=-30-2.5
scene.add(w6)
w3.position.y=w4.position.y=w5.position.y=w6.position.y=bR
//2
world2D.sl01.setLabel("彈力係數 兩側/中間")
world2D.sl01.maximum=20
world2D.sl01.minimum=0.1
world2D.sl01.value=1
//world2D.mouse.on("mousedown",msd)
//world2D.mouse.on("mouseup",msu)
...
function tick(){
	...
	k1=k2*world2D.sl01.value
var dxa=b1.position.x-(-15)
var dxb=b2.position.x-(15)
b1.ax=-k1*dxa-k2*(dxa-dxb)
b2.ax=-k1*dxb+k2*(dxa-dxb)
b1.vx+=b1.ax*dt
b2.vx+=b2.ax*dt
	b1.position.x+=b1.vx*dt
	b2.position.x+=b2.vx*dt
spr1.position.x=-40
spr1.setSpring(b1.position.x-bR-(-40),0,b1.position.z)
spr2.position.x=b1.position.x+bR
spr2.position.z=b1.position.z
spr2.setSpring(b2.position.x-b1.position.x-2*bR,0,b2.position.z-b1.position.z)
spr3.position.x=b2.position.x+(45-b2.position.x-bR)
spr3.setSpring(-(40-b2.position.x-bR),0,b2.position.z)
	//z
	var dza=b1.position.z
var dzb=b2.position.z
b1.az=-k3*dza*2
b2.az=-k3*dzb*2
b1.vz+=b1.az*dt
b2.vz+=b2.az*dt
	b1.position.z+=b1.vz*dt
	b2.position.z+=b2.vz*dt
	sp4.position.z=30
	sp4.position.x=-15
	sp4.setSpring(b1.position.x-sp4.position.x,0,-(30-bR-b1.position.z))
	sp5.position.z=-30
	sp5.position.x=-15
	sp5.setSpring(b1.position.x-sp4.position.x,0,(30-bR+b1.position.z))
	sp6.position.z=30
	sp6.position.x=15
	sp6.setSpring(b2.position.x-sp6.position.x,0,-(30-bR-b2.position.z))
	sp7.position.z=-30
	sp7.position.x=15
	sp7.setSpring(b2.position.x-sp6.position.x,0,(30-bR+b2.position.z))
	//圖
	graph.addPoint(b1.position.x,b1.position.z)
	log(graph.addPoint())
	//3D
	world3D.render();
	//2D
