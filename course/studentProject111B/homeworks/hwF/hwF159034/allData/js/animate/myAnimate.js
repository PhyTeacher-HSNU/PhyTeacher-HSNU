...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.ch03.setTransform(1417.2,462.7,1,1,0,0,0,67.2,-1.4);

	this.ch02 = new lib.theCheckbox();
	this.ch02.name = "ch02";
	this.ch02.parent = this;
	this.ch02.setTransform(1417.2,390.55,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1417.2,318.4,1,1,0,0,0,67.2,-1.4);
