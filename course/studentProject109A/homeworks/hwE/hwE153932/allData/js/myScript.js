...
var dt=0.01;
var aa=3;
var z1=-30,z2=0,z3=30;
var w1,w2,w3,w4,w5,w6;
var e1,e2,e3,e4,e5,e6;
var flr,flr2,flr3,flr4;
var so;
var na;
//B.定義init
function init(){
	so=new TEACHER.ObjBox(100,3,100,0x5E2612,0);
	scene.add(so);

	na=new TEACHER.ObjTextPlane(90,15,"153932 盧德瑜","z",0x0000ff,0xffffff);
	scene.add(na);
	na.position.y=10;
	na.position.x=0;
	na.position.z=-45;
	...
	flr=new TEACHER.ObjPicCylinder(2,27,pics.flor1,false,"y",0);
	scene.add(flr);
	flr.position.y=15;
	flr.position.x=-48;
	flr.position.z=-3;

	flr2=new TEACHER.ObjPicCylinder(2,30,pics.flor2,false,"y",0);
	scene.add(flr2);
	flr2.position.y=15;
	flr2.position.x=33;
	flr2.position.z=-18;
	...
	flr3=new TEACHER.ObjPicCylinder(2,29,pics.f3,false,"y",0);
	scene.add(flr3);
	flr3.position.y=15;
	flr3.position.x=13;
	flr3.position.z=44;
	...
	for(var i=0 ; i<nm;i++){
		var b4=new TEACHER.ObjSphere(2,0xA0522D);
		b4.position.x=-50+i*2;
		b4.position.y=0.5;
		b4.position.z=28;
		scene.add(b4);
		ballArray4.push(b4);
	...
	for(var i=0 ; i<nn ; i++){
		...
		var b=new TEACHER.ObjSphere(3,0xffff00);
		b.position.x=-50+i*2;
		b.position.y=1;
		b.position.z=z1;
		scene.add(b);
		...
		var b2=new TEACHER.ObjSphere(3,0xffff00);
		b2.position.x=-50+i*2;
		b2.position.y=1;
		b2.position.z=z2;
		scene.add(b2);
		ballArray2.push(b2);

		var b3=new TEACHER.ObjSphere(3,0xffff00);
		b3.position.x=-50+i*2;
		b3.position.y=1;
		b3.position.z=z3;
		scene.add(b3);
		ballArray3.push(b3);
		...
		var w1=new TEACHER.ObjCylinder(2,1,0x66FFE6,false,"y",0);
		w1.position.z=b.position.z+34;
		var bb=ballArray1[i];
		if(bb=ballArray1[1]){
			bb.add(w1);
		}
		var w2=new TEACHER.ObjCylinder(2,0.6,0x66FFE6,false,"y",0);
		w2.position.z=b.position.z+26;
		var bb=ballArray1[i];
		if(bb=ballArray1[1]){
			bb.add(w2);
		}
		var w3=new TEACHER.ObjCylinder(2,0.6,0x66FFE6,false,"y",0);
		w3.position.z=b.position.z+34;
		var bb=ballArray2[i];
		if(bb=ballArray2[1]){
			bb.add(w3);
		}
		var w4=new TEACHER.ObjCylinder(2,0.6,0x66FFE6,false,"y",0);
		w4.position.z=b.position.z+26;
		var bb=ballArray2[i];
		if(bb=ballArray2[1]){
			bb.add(w4);
		}
		var w5=new TEACHER.ObjCylinder(2,0.6,0x66FFE6,false,"y",0);
		w5.position.z=b.position.z+34;
		var bb=ballArray3[i];
		if(bb=ballArray3[1]){
			bb.add(w5);
		}
		var w6=new TEACHER.ObjCylinder(2,0.6,0x66FFE6,false,"y",0);
		w6.position.z=b.position.z+26;
		var bb=ballArray3[i];
		if(bb=ballArray3[1]){
			bb.add(w6);
		}

		var e1=new TEACHER.ObjSphere(1,0x111111,0);
		e1.position.z=b.position.z+33;
		e1.position.y=b.position.y+1.5;
		var bb=ballArray1[i];
		if(bb=ballArray1[2]){
			bb.add(e1);
		}
		var e2=new TEACHER.ObjSphere(1,0x111111,0);
		e2.position.z=b.position.z+27;
		e2.position.y=b.position.y+1.5;
		var bb=ballArray1[i];
		if(bb=ballArray1[2]){
			bb.add(e2);
		}
		var e3=new TEACHER.ObjSphere(1,0x111111,0);
		e3.position.z=b.position.z+33;
		e3.position.y=b.position.y+1.5;
		var bb=ballArray2[i];
		if(bb=ballArray2[2]){
			bb.add(e3);
		}
		var e4=new TEACHER.ObjSphere(1,0x111111,0);
		e4.position.z=b.position.z+27;
		e4.position.y=b.position.y+1.5;
		var bb=ballArray2[i];
		if(bb=ballArray2[2]){
			bb.add(e4);
		}
		var e5=new TEACHER.ObjSphere(1,0x111111,0);
		e5.position.z=b.position.z+33;
		e5.position.y=b.position.y+1.5;
		var bb=ballArray3[i];
		if(bb=ballArray3[2]){
			bb.add(e5);
		}
		var e6=new TEACHER.ObjSphere(1,0x111111,0);
		e6.position.z=b.position.z+27;
		e6.position.y=b.position.y+1.5;
		var bb=ballArray3[i];
		if(bb=ballArray3[2]){
			bb.add(e6);
		}

		world2D.sl01.setLabel("vbee");
		world2D.sl01.minimum=-0.5;
		world2D.sl01.maximum=0.5;
		world2D.sl01.value=0.01;
		world2D.sl01.digitN=3;
...
function tick(){
	...
	tt+=dt=world2D.sl01.value;
	for(var i=0;i<nm;i++){
		var b4=ballArray4[i];
		var yy4= aa*Math.sin(Math.PI*b4.position.x/lambda + 17*Math.PI*tt/period);
		b4.position.y=yy4+3;
		b4.position.x+=dt*1.5;
		b4.position.z=z3+2
	
	if(b4.position.x > 50 ){
		yy4= aa*Math.sin(Math.PI*b4.position.x/lambda - 17*Math.PI*tt/period);
	}else if(b4.position.x<-50){
		yy4= aa*Math.sin(Math.PI*b4.position.x/lambda + 17*Math.PI*tt/period);
	}
    }
	...
	for(var i=0 ; i<nn ; i++){
		var b=ballArray1[i];
		var yy = aa*Math.sin(Math.PI*b.position.x/lambda + 17*Math.PI*tt/period);
		b.position.y=yy+7;
		b.position.x+=dt*2;

		var b2=ballArray2[i];
		var yy2 = aa*Math.sin(Math.PI*b.position.x/lambda + 17*Math.PI*tt/period);
		b2.position.y=yy2+32;
		b2.position.x+=dt*2.5;

		var b3=ballArray3[i];
		var yy3 = aa*Math.sin(Math.PI*b.position.x/lambda + 17*Math.PI*tt/period);
		b3.position.y=yy3+20;
		b3.position.x+=dt*1.5;
