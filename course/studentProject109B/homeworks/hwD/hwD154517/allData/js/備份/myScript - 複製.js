...
function init(){
	...
	world2D.ch01.setLabel("紅行星恆星");
	world2D.ch01.checked = true;
	world2D.ch02.setLabel("藍行星恆星");
...
function tick(){
	...
	B1.position.x = 32*Math.cos(theta1);
	B1.position.z = 32*Math.sin(theta1);

	B2.position.x = 60*Math.cos(theta2);
	B2.position.z = 60*Math.sin(theta2);

	b1.position.x = B1.position.x+7*Math.cos(theta3);
	b1.position.z = B1.position.z+7*Math.sin(theta3);
	b1.visible = world2D.ch01.checked;
	
	b2.position.x = B2.position.x+15*Math.cos(theta4);
	b2.position.z = B2.position.z+15*Math.sin(theta4);
