...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.ch01.setTransform(1200,70,1,1,0,0,0,67.2,-1.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn04},{t:this.btn07},{t:this.btn06},{t:this.btn05},{t:this.btn03},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
