...
//B.定義init
function init(){
	word = new TEACHER.ObjTextPlane(60,10,`157303 朱浩鋒`,`z`)
    scene.add(word)
	word.position.z = -50
	word.position.x = -30
	word.position.y = 15
    ...
    world2D.btn01.setLabel(`左右滾動`)
	world2D.btn02.setLabel(`歸位`)
	...
	world2D.sl01.setLabel(`眼距`)
	world2D.sl01.minimum=-4
	world2D.sl01.maximum=12
	world2D.sl01.value=0
	world2D.sl01.digitN=1

	world2D.sl02.setLabel(`大小`)
	world2D.sl02.minimum=0.5
	world2D.sl02.maximum=2.5
	world2D.sl02.value=1
	world2D.sl02.digitN=1

	world2D.sl03.setLabel(`旋轉`)
	world2D.sl03.minimum=-360
	world2D.sl03.maximum=360
	world2D.sl03.value=0
	world2D.sl03.digitN=1

	world2D.ch01.setLabel(`可視`)

	world2D.ch02.setLabel(`過動警告`)
...
//C.定義tick                                                                                                                       
function tick(){
	//smile.scale.x=smile.scale.y=smile.scale.z=world2D.sl01
	smile.visible= world2D.ch01.check
	...
	if(GM==1){
		...
		smile.position.x+=dx
		smile.rotation.z-=(dx/r)
	}if(GM==2){

	}else if(GM==0){

	}
	smile.eyeL.position.x=(-world2D.sl01.value-8)
	smile.eyeR.position.x=(world2D.sl01.value+8)
	smile.eyeL.position.y=8
	smile.eyeR.position.y=8

	smile.eyeL.rotation.x=0
	smile.eyeL.rotation.z=0
	smile.eyeR.rotation.x=0
	smile.eyeR.rotation.z=0
	smile.eyeL.rotation.y=0
	smile.eyeR.rotation.y=0
	
	    

	smile.scale.x=smile.scale.y=smile.scale.z=world2D.sl02.value
	smile.position.y=(world2D.sl02.value*20)

	smile.rotation.y=(world2D.sl03.value*Math.PI/180)

	smile.visible=world2D.ch01.checked

	if(world2D.ch02.checked===true){
	    random = Math.random()*5
		smile.position.x+=random
		smile.position.y+=random
		smile.position.z+=random
		smile.eyeL.position.x+=random
		random = Math.random()*5
		smile.eyeL.position.y+=random
		random = Math.random()*5
		smile.eyeR.position.x+=random
		random = Math.random()*5
		smile.eyeR.position.y+=random
		random = Math.random()*5
		smile.position.x-=random
		smile.position.y-=random
		smile.position.z-=random
		...
		smile.eyeL.rotation.x=random
		random = Math.random()*360
		smile.eyeL.rotation.y=random
		random = Math.random()*360
		smile.eyeL.rotation.z=random
		random = Math.random()*360
		smile.eyeR.rotation.x=random
		random = Math.random()*360
		smile.eyeR.rotation.y=random
		random = Math.random()*360
		smile.eyeR.rotation.z=random
		smile.eyeL.position.z=5
		smile.eyeR.position.z=5

	    
	    
	}else{
		smile.eyeL.position.z=0
		smile.eyeR.position.z=0
	}
...
function clickbtn(e){
	...
	if(str==`btn01`){
		 ...
		 GM=3
		 smile.position.x=smile.position.z=0
		 world2D.sl03.value=0
