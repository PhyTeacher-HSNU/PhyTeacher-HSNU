...
//B.定義init
function init(){
	center = new TEACHER.ObjCylinder(1, 20, 0x00ffff);
	scene.add(center);
	...
	for (let i = 0; i < mxn; i++) {
		...
		b.position.y = bar.position.y = center.position.y = br;
		b.vx = b.vy = b.vz = 0;
	...
	world2D.sl03.setLabel("球數 按還原確認");
	...
	world2D.ch01.visible = world2D.ch02.visible = world2D.btnUp.visible = world2D.btnDown.visible = world2D.btnLeft.visible = world2D.btnRight.visible = false;
