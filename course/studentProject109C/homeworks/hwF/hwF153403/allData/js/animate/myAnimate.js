...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.ch02.setTransform(1417.2,480,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1417.2,440,1,1,0,0,0,67.2,-1.4);

	this.sl03 = new lib.theSlider();
	this.sl03.name = "sl03";
	this.sl03.parent = this;
	this.sl03.setTransform(1350,175);

	this.sl02 = new lib.theSlider();
	this.sl02.name = "sl02";
	this.sl02.parent = this;
	this.sl02.setTransform(1350,135);

	this.sl01 = new lib.theSlider();
	this.sl01.name = "sl01";
	this.sl01.parent = this;
	this.sl01.setTransform(1350,95);

	this.sl00 = new lib.theSlider();
	this.sl00.name = "sl00";
	this.sl00.parent = this;
	this.sl00.setTransform(1350,55);

	this.sl001 = new lib.theSlider();
	this.sl001.name = "sl001";
	this.sl001.parent = this;
	this.sl001.setTransform(1350,15);

	this.sl002 = new lib.theSlider();
	this.sl002.name = "sl002";
	this.sl002.parent = this;
	this.sl002.setTransform(1350,375);

	this.sl04 = new lib.theSlider();
	this.sl04.name = "sl04";
	this.sl04.parent = this;
	this.sl04.setTransform(1350,215);

	this.sl05 = new lib.theSlider();
	this.sl05.name = "sl05";
	this.sl05.parent = this;
	this.sl05.setTransform(1350,255);

	this.sl06 = new lib.theSlider();
	this.sl06.name = "sl06";
	this.sl06.parent = this;
	this.sl06.setTransform(1350,295);

	this.sl07 = new lib.theSlider();
	this.sl07.name = "sl07";
	this.sl07.parent = this;
	this.sl07.setTransform(1350,335);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.sl00},{t:this.sl002},{t:this.sl001},{t:this.sl04},{t:this.sl05},{t:this.sl06},{t:this.sl07},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
