...
//A.宣告全域變數
var ball1 , center1 , bar1
var ball2 , center2 , bar2
var ball3 , center3 , bar3
var ball4 , bar4
var ball5 , bar5
var ball6 , bar6
var Ball
...
var rrrrrrr=1.575
var omega=0.2
var theta1 , theta2 , theta3 , theta4 , theta5 , theta6 
var dt=0.02
var arrowV
var ll=6
var lll=0
...
function init(){
	...
	ball1=new TEACHER.ObjSphere(1,0xfffff0)
	bar1=new TEACHER.ObjCylinder(0.4,rr,0x222222,false,"x")
	center1=new TEACHER.ObjCylinder(3,6,0x333366,false,"y")
	ball2=new TEACHER.ObjSphere(1,0xffff0f)
	bar2=new TEACHER.ObjCylinder(0.2,rrr,0x222222,false,"x")
	ball3=new TEACHER.ObjSphere(1,0xfff0ff)
	bar3=new TEACHER.ObjCylinder(0.2,rrrr,0x222222,false,"x")
	ball4=new TEACHER.ObjSphere(1,0xff0fff)
	bar4=new TEACHER.ObjCylinder(0.2,rrrrr,0x222222,false,"x")
	ball5=new TEACHER.ObjSphere(1,0xf0ffff)
	bar5=new TEACHER.ObjCylinder(0.2,rrrrrr,0x222222,false,"x")
	ball6=new TEACHER.ObjSphere(1,0x0fffff)
	bar6=new TEACHER.ObjCylinder(0.2,rrrrrrr,0x222222,false,"x")
	myline=new TEACHER.Line(0xdddddd,100000)
	//Ball=new TEACHER.ObjSphere(4,0xdddddd)

	theta1 = theta2 = theta3 = theta4 = theta5 = theta6 = 0
	
	//arrowV=new TEACHER.ObjArrow(1,0xdd2222)

	scene.add(ball1).add(bar1).add(center1)
	ball1.add(ball2).add(bar2)
	ball2.add(ball3).add(bar3)
	ball3.add(ball4).add(bar4)
	ball4.add(ball5).add(bar5)
	ball5.add(ball6).add(bar6)
	scene.add(Ball)
	//ball1.add(arrowV)
	ball1.position.y=bar1.position.y=center1.position.y=3
	center1.position.x-=25
	ball1.position.x-=50
	bar1.position.x-=50
...
function tick(){
	...
	theta5+=omega*dt*9
	theta6+=omega*dt*11
	ball1.position.x=rr*Math.cos(theta1)-25
	ball1.position.z=rr*Math.sin(theta1)
	bar1.position.x=rr*Math.cos(theta1)*0.5-25
	bar1.position.z=rr*Math.sin(theta1)*0.5
	bar1.rotation.y=-theta1
	ball2.position.x=rrr*Math.cos(theta2)//rr*Math.cos(theta)
	ball2.position.z=rrr*Math.sin(theta2)//rr*Math.sin(theta)
	bar2.position.x=rrr*Math.cos(theta2)*0.5//rr*Math.cos(theta)*0.5
	bar2.position.z=rrr*Math.sin(theta2)*0.5//rr*Math.sin(theta)*0.5
	bar2.rotation.y=-theta2
	ball3.position.x=rrrr*Math.cos(theta3)
	ball3.position.z=rrrr*Math.sin(theta3)
	bar3.position.x=rrrr*Math.cos(theta3)*0.5
	bar3.position.z=rrrr*Math.sin(theta3)*0.5
	bar3.rotation.y=-theta3
	ball4.position.x=rrrrr*Math.cos(theta4)
	ball4.position.z=rrrrr*Math.sin(theta4)
	bar4.position.x=rrrrr*Math.cos(theta4)*0.5
	bar4.position.z=rrrrr*Math.sin(theta4)*0.5
	bar4.rotation.y=-theta4
	ball5.position.x=rrrrrr*Math.cos(theta5)
	ball5.position.z=rrrrrr*Math.sin(theta5)
	bar5.position.x=rrrrrr*Math.cos(theta5)*0.5
	bar5.position.z=rrrrrr*Math.sin(theta5)*0.5
	bar5.rotation.y=-theta5
	ball6.position.x=rrrrrrr*Math.cos(theta6)
	ball6.position.z=rrrrrrr*Math.sin(theta6)
	bar6.position.x=rrrrrrr*Math.cos(theta6)*0.5
	bar6.position.z=rrrrrrr*Math.sin(theta6)*0.5
	bar6.rotation.y=-theta6
	myline.addPoint(/*ball1.position.x+ball2.position.x+ball3.position.x+*/lll,ll,ball1.position.z+ball2.position.z+ball3.position.z+ball4.position.z+ball5.position.z+ball6.position.z)
	lll+=dt
	//ll=ll+dt*0.1

	//Ball.position.x=ball1.position.x
	//Ball.position.z=ball1.position.z
	//Ball.position.y=ll+4

	}
	//var vv=rr*omega
	
	//arrowV.setArrow(-vv*Math.sin(theta)*2,0,vv*Math.cos(theta)*2)
