...
var pp= new TEACHER.ObjTextPlane(160,20,"160221 許友豪")
	scene.add(pp)
	pp.scale.x=0.9
	pp.position.y=25
	pp.position.z=-49
var dd= new TEACHER.ObjBox(2,2,100,0x4b0082)
scene.add(dd)
dd.position.x=51
dd.position.y=1

var dd= new TEACHER.ObjBox(2,2,20,0x4b0082)
scene.add(dd)
dd.position.x=-51
dd.position.y=1
dd.position.z=40
var gg= new TEACHER.ObjBox(2,2,40,0xff00ff)
scene.add(gg)
gg.position.x=-51
gg.position.y=1
gg.position.z=-30

var gg= new TEACHER.ObjBox(2,2,40,0xff0000)
scene.add(gg)
gg.position.x=-51
gg.position.y=1
gg.position.z=10
...
var dd= new TEACHER.ObjBox(104,2,2,0x4b0082)
scene.add(dd)
dd.position.z=51
dd.position.y=1
var dd= new TEACHER.ObjBox(104,40,2,0x4b0082)
scene.add(dd)
dd.position.z=-51.1
dd.position.y=20

var zz= new TEACHER.ObjBox(4,2,90,0x4b0082)
scene.add(zz)
zz.position.x=40
zz.position.y=1
zz.position.z=5

var yy= new TEACHER.ObjBox(4,2,90,0x4b0082)
scene.add(yy)
yy.position.x=17.5
yy.position.y=1
yy.position.z=-5

var xx= new TEACHER.ObjBox(4,2,90,0x4b0082)
scene.add(xx)
xx.position.x=-5
xx.position.y=1
xx.position.z=5

var ww= new TEACHER.ObjBox(4,2,90,0x4b0082)
scene.add(ww)
ww.position.x=-27.5
ww.position.y=1
ww.position.z=-5
...
arrowV.visible=false
	...
	world2D.btn01.on('cilck',clickBtn)
	...
	world2D.ch01.setLabel('輔助')
    world2D.ch02.setLabel('回原點障礙物')
	world2D.sl02.visible=false
	world2D.sl03.visible=false
	world2D.btn01.visible=false
  
ee= new TEACHER.ObjBox(8,4,8,0xff00ff)	
scene.add(ee)
ee.position.z=46
ee.position.x=-11
ee.position.y=2
...
//C.定義tick                                                                                                                       
function tick(){
   f=world2D.ch01.checked
   ob=world2D.ch02.checked
   if(f){
	arrowA.visible=true
	arrowV.visible=true
   arrowA.scale.x=arrowA.scale.y=arrowA.scale.z=1
   arrowV.scale.x=arrowV.scale.y=arrowV.scale.z=1
   arrowA.position.x=arrowV.position.x=bb.position.x
   arrowA.position.y=bb.position.y+4
   arrowA.position.z=arrowV.position.z=bb.position.z
   arrowV.position.y=bb.position.y+2
   arrowV.setArrow(vx , vy , vz)
   arrowA.setArrow(ax*3 , ay*3 , az*3)
   ...
   if(bb.position.x>48 && vx>0){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x<-48 && vx<0){
	vx*=-1*world2D.sl01.value
   }
   if(bb.position.z>48 && vz>0){
	vz*=-1*world2D.sl01.value
   }else if(bb.position.z<-48 && vz<0){
	vz*=-1*world2D.sl01.value
   }

   if(bb.position.x<44 && vx<0 && bb.position.z>-44 && bb.position.x>43){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x>36 && vx>0 && bb.position.z>-44 && bb.position.x<37){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x<21.5 && vx<0 && bb.position.z<40 && bb.position.x>21){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x>13.5 && vx>0 && bb.position.z<40 && bb.position.x<20){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x<-1 && vx<0 && bb.position.z>-44 && bb.position.x>-3){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x>-9 && vx>0 && bb.position.z>-44 && bb.position.x<-6){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x<-23.5 && vx<0 && bb.position.z<40 && bb.position.x>-24){
	vx*=-1*world2D.sl01.value
   }else if(bb.position.x>-31.5 && vx>0 && bb.position.z<40 && bb.position.x<-30){
	vx*=-1*world2D.sl01.value
   }
   if(bb.position.z<-10 && bb.position.z>=-50 && bb.position.x<=-48){
	var ddd=new TEACHER.ObjTextPlane(80,20,"很強喔",0,0x000000,0xff00ff)
    scene.add(ddd)
    ddd.position.y=10
	bb.position.y=2
    bb.position.z=48
   ...
   if(bb.position.z<=30 && bb.position.z>-10 && bb.position.x<=-48){
	var dddd=new TEACHER.ObjTextPlane(80,20,"嫩",0,0x000000,0xff0000)
    scene.add(dddd)
    dddd.position.y=10
	dt=0
}
   ...
   if(ob){
	ee.visible=true
	if(-15<bb.position.x && bb.position.x<-6 && 40<bb.position.z && bb.position.z<50){
		dt=0
	}
   }else(ee.visible=false)
