...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btn03.setTransform(1500,450);

	this.btn04 = new lib.theButton();
	this.btn04.name = "btn04";
	this.btn04.parent = this;
	this.btn04.setTransform(1350,450);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch02},{t:this.btn01},{t:this.btn03},{t:this.btn04},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
