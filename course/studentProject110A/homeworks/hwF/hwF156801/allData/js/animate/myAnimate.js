...
(lib.myAnimate = function(mode,startPosition,loop) {
	...
	this.btn01.setTransform(1500,770);

	this.ch04 = new lib.theCheckbox();
	this.ch04.name = "ch04";
	this.ch04.parent = this;
	this.ch04.setTransform(1340,584.55,1,1,0,0,0,67.2,-1.4);

	this.ch03 = new lib.theCheckbox();
	this.ch03.name = "ch03";
	this.ch03.parent = this;
	this.ch03.setTransform(1340,512.55,1,1,0,0,0,67.2,-1.4);

	this.ch02 = new lib.theCheckbox();
	this.ch02.name = "ch02";
	this.ch02.parent = this;
	this.ch02.setTransform(1340,440.55,1,1,0,0,0,67.2,-1.4);

	this.ch01 = new lib.theCheckbox();
	this.ch01.name = "ch01";
	this.ch01.parent = this;
	this.ch01.setTransform(1340,368.4,1,1,0,0,0,67.2,-1.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.sl01},{t:this.sl02},{t:this.sl03},{t:this.ch01},{t:this.ch02},{t:this.ch03},{t:this.ch04},{t:this.btn01},{t:this.btn02},{t:this.slCameraRR},{t:this.btnUp},{t:this.btnDown},{t:this.btnRight},{t:this.btnLeft}]}).wait(1));
