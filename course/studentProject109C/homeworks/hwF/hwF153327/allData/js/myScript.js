...
function init(){
	...
	water=new TEACHER.ObjPicPlane(10,100,pics.water);
	water.rotation.x=-3.14/2;
	water.position.y=1;
	scene.add(water);
	car=new TEACHER.ObjBox(30,10,20,0xffff00);
	scene.add(car);
	car.position.y=30;
	car.position.x=-10;
	ball1=new TEACHER.ObjCylinder(0.01,2,0xff0000);
	scene.add(ball1);
	ball1.position.y=40;
	ball1.rotation.x=3.14/2;
	ball1.v=0;
	ball1.position.x=-20;
	ball2=new TEACHER.ObjCylinder(0.01,2,0xff0000);
	scene.add(ball2);
	ball2.position.y=40;
	ball2.rotation.x=3.14/2;
	ball2.v=0;
	spring1=new TEACHER.ObjSpring(l,3,0.5,8,0xff0000);
	scene.add(spring1);
	spring1.position.x=-20;
	spring2=new TEACHER.ObjSpring(l,3,0.5,8,0xff0000);
	scene.add(spring2);
	wheel1=new TEACHER.ObjCylinder(5,5,0xff0000);
	scene.add(wheel1);
	wheel1.position.y=5;
	wheel1.rotation.x=3.14/2;
	wheel1.position.x=-20;
	wheel2=new TEACHER.ObjCylinder(5,5,0xff0000);
	scene.add(wheel2);
	wheel2.position.y=5;
	wheel2.rotation.x=3.14/2;
...
function tick(){
	...
	b=world2D.sl02.value/100;
	l=world2D.sl03.value;
	if(car.position.x>50 && v>0){
		v*=-1;
	}
	else if(car.position.x<-50 && v<0){
		v*=-1;
	}
	...
	if(ball2.position.x<1 && ball2.position.x>-1 ){
		var k2=30;
	}
	else{
		var k2=40;
	}	
	ball1.a=-k/m*(ball1.position.y-k1)-b/m*ball1.v;
	ball1.v+=ball1.a*dt;
	ball1.position.y+=ball1.v*dt;
	spring1.position.y=5+2.5;
	spring1.setSpring(0,-(l-ball1.position.y+2.5),0);
	ball2.a=-k/m*(ball2.position.y-k2)-b/m*ball2.v;
	ball2.v+=ball2.a*dt;
	ball2.position.y+=ball2.v*dt;
	spring2.position.y=5+2.5;
	spring2.setSpring(0,-(l-ball2.position.y+2.5),0);
	ball1.position.x+=v*dt;
	ball2.position.x+=v*dt;
	spring1.position.x+=v*dt;
	spring2.position.x+=v*dt;
	car.position.x+=v*dt;
	wheel1.position.x+=v*dt;
	wheel2.position.x+=v*dt;
	car.position.y=(-(l-ball1.position.y+2.5)-(l-ball2.position.y+2.5))/2+10;
	car.rotation.z=-(-(l-ball1.position.y+2.5)+(l-ball2.position.y+2.5))/2/10;
