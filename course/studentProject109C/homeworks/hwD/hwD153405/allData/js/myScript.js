...
function init(){
	...
	for(var i=0;i<nn;i++){
		var ball1=new TEACHER.ObjSphere(3,0x5F9F9F,5);
		ball1.position.x=-250+2*i;
		ball1.position.y=10;
		ball1.position.z=z1;
		scene.add(ball1);
		ballArray1.push(ball1);

		var ball2=new TEACHER.ObjSphere(3,0x4F4F2F,5);
		ball2.position.x=-250+2*i;
		ball2.position.y=10;
		ball2.position.z=z2;
		scene.add(ball2);
		ballArray2.push(ball2);

		var ball3=new TEACHER.ObjSphere(3,0x7093DB,5);
		ball3.position.x=-250+2*i;
		ball3.position.y=10;
		ball3.position.z=z3;
		scene.add(ball3);
		ballArray3.push(ball3);
	...
	world2D.btn01.setLabel("1534");
	
	world2D.btn02.setLabel("呂東晉");
	...
	world2D.sl02.value=50;
        ...
        world2D.ch01.setLabel("三合一")

	world2D.ch02.setLabel("dt=0")

	world2D.sl03.setLabel("How fast")
	...
	stars1 = new TEACHER.Points(0xCFB53B , 1.25);
	scene.add(stars1);
	for(var i=0 ; i<100 ; i++){
		...
		for(var ix=-1 ; ix<=1 ; ix++){ 
			for(var iy=-1 ; iy<=1 ; iy++){
				for(var iz=-1 ; iz<=1 ; iz++){
					stars1.addPoint(xx+ix*100 , yy+iy*100, zz+iz*100);
				}
			}   
		}
	}
stars2 = new TEACHER.Points(0xffffff , 1);
	scene.add(stars2);
	for(var i=0 ; i<100 ; i++){
		var xx=100*(Math.random()-0.5); 
		var yy=100*(Math.random()-0.5); 
		...
		for(var ix=-1 ; ix<=1 ; ix++){ 
			for(var iy=-1 ; iy<=1 ; iy++){
				for(var iz=-1 ; iz<=1 ; iz++){
					stars2.addPoint(xx+ix*100 , yy+iy*100, zz+iz*100);
				}
			}   
		}
	}

	stars3 = new TEACHER.Points(0xCD7F32, 1.5);
	scene.add(stars3);
	for(var i=0 ; i<100 ; i++){
		var xx=100*(Math.random()-0.5); 
		var yy=100*(Math.random()-0.5); 
		...
		for(var ix=-1 ; ix<=1 ; ix++){ 
			for(var iy=-1 ; iy<=1 ; iy++){
				for(var iz=-1 ; iz<=1 ; iz++){
					stars3.addPoint(xx+ix*100 , yy+iy*100, zz+iz*100);
				}
			}   
		}
	}
...
function tick(){
	...
	for(var i=0;i<nn;i++){
		...
		var yy1=AA*Math.sin( 2*Math.PI*b1.position.x/lambda - 2*Math.PI*t/period );
		var yy2=AA*Math.sin( 2*Math.PI*b2.position.x/lambda + 2*Math.PI*t/period );
		var yy3=yy1+yy2;
    ...
    stars1.position.x=-xx;
	stars1.position.y=-yy;
	stars1.position.z=-zz;
stars2.position.x=-xx;
	stars2.position.y=-yy;
	stars2.position.z=-zz;
stars3.position.x=-xx;
	stars3.position.y=-yy;
	stars3.position.z=-zz;
    ...
    var is3in1=world2D.ch01.checked;
	if(is3in1){
        z1=0.5*z1+0.5*0
		z2=0.5*z2+0.5*0
		z3=0.5*z3+0.5*0
	...
	var dtis0=world2D.ch02.checked;
	if(dtis0){
        yy1=yy2=yy3=0
	}else{
		dt=world2D.sl03.value;
